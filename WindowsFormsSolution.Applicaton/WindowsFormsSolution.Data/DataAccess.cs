...
namespace WindowsFormsSolution.Data
{
    public class DataAccess
    {
        ...
        public static SqlConnection SqlCon
        {
            get
            {
                if (sqlCon == null)
                {
                    sqlCon = new SqlConnection(@"Data Source=DESKTOP-N84QHS8\MAHIN;Initial Catalog=footballdb;Persist Security Info=True;User ID=sa;Password=123");
                }
